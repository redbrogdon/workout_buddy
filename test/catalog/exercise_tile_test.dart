...
void main() {
  testWidgets('ExerciseTile displays name and details correctly', (WidgetTester tester) async {
  ...
  testWidgets('ExerciseTile displays duration correctly', (WidgetTester tester) async {
    final data = ExerciseTileData(
      name: 'Plank',
      sets: 1,
      duration: 60,
